        ...
        <Container>
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight">
              Bet Smarter.<br />
              <span className="text-gold">Win Bigger.</span>
            </h1>
      ...
      <section className="border-y border-brand bg-surface/50 py-8">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-brand">
            ...
            <div className="flex flex-col items-center justify-center p-4">
              <CircleDollarSign className="w-8 h-8 text-gold mb-2" />
      ...
      <section className="py-16">
        <Container>
          <div className="flex justify-between items-end mb-8">
            ...
            <Link href="/sports" className="text-gold hover:text-yellow-400 text-sm font-semibold">
              View All &rarr;
            </Link>
          </div>
