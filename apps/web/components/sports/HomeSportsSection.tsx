      ...
      <div className="relative z-30" ref={dropdownRef}>
        <div className="flex items-center gap-1.5 px-3 py-2.5 border-b border-gray-100 bg-white">
          ...
          <button
            ...
            className={`flex-[1.4] flex items-center justify-center gap-1 py-2 rounded-lg text-[11px] font-bold transition-all ${
        ...
        {openDropdown === 'countries' && (
          <div className="absolute left-0 right-0 top-full bg-white border border-gray-200 shadow-xl max-h-80 overflow-y-auto z-40">
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 border-b border-gray-100 ${!selectedCountry ? 'bg-[#E8FFF2] text-[#0D8A3C] font-bold' : 'text-gray-600 hover:bg-gray-50'}`}
            >
            ...
            {allCountries.length === 0 ? (
              ...
              <button key={c.country}
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 border-b border-gray-50 ${selectedCountry?.country === c.country ? 'bg-[#E8FFF2] text-[#0D8A3C]' : 'text-gray-700 hover:bg-gray-50'}`}
              >
                {c.flag
        ...
        {/* ── Leagues Dropdown (sorted by popularity) ───────────────── */}
          ...
          <div className="absolute left-0 right-0 top-full bg-white border border-gray-200 shadow-xl max-h-80 overflow-y-auto z-40">
            ...
            {allLeagues.length === 0 ? (
              ...
              <button key={l.id}
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 border-b border-gray-50 ${selectedLeague?.id === l.id ? 'bg-[#E8FFF2] text-[#0D8A3C]' : 'text-gray-700 hover:bg-gray-50'}`}
              >
                {l.logo
